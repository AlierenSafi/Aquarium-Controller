...
unsigned long temperatureTaskPeriod = 120000;  // Default period: 120 seconds
...
void setup() {
  ...
  // Create tasks
  xTaskCreate(processSerialCommand, "ProcessSerialCommand", 1024, NULL, 2, &xProcessSerialCommand);
  xTaskCreate(measureTemperature, "MeasureTemperature", 256, NULL, 1, &xMeasureTemperature);
  xTaskCreate(connectionControl, "ConnectionControl", 256, NULL, 3, &xConnectionControl);
